...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://pwqik55mxi.execute-api.us-east-1.amazonaws.com/test';
    ...
    apigClient.uploadFolderItemPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['x-api-key', 'item', 'folder'], ['body']);
