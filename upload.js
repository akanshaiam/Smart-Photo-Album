...
function searchPhoto() {
  ...
  var apigClient = apigClientFactory.newClient({
    apiKey: 'HVukUOTw5w9mCPfEyBK8e9pBjt6zOgJ6mcMNn0K8'
  });
  ...
  var params = {
    q: image_message,
    'x-api-key': 'HVukUOTw5w9mCPfEyBK8e9pBjt6zOgJ6mcMNn0K8'
  };
...
function uploadPhoto() {
  ...
  let config = {
   ...
   url = 'https://cors-anywhere.herokuapp.com/https://pwqik55mxi.execute-api.us-east-1.amazonaws.com/test/upload/photos-for-album/' + file.name
